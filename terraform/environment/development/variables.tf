locals {
  ...
  resource_domain                    = local.config["development"].resource_domain
  resource_bucket_name               = local.config["development"].resource_bucket_name
  resource_acm_certificate_arn       = local.config["development"].resource_acm_certificate_arn
