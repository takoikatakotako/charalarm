...
aws dynamodb put-item \
    --endpoint-url $ENDPOINT_URL \
    --table-name chara-table \
    --item '{"charaID":{"S":"jp.zunko.zundamon"},"enable":{"BOOL":true},"name":{"S":"ずんだもん"},"created_at":{"S":"2026-07-31"},"updated_at":{"S":"2026-07-31"},"description":{"S":"ずんだの妖精なのだ。ずんだもんと呼んでほしいのだ！VOICEVOXの声で、電話をかけるとおしゃべりもできるのだ〜。よろしくなのだ！"},"profiles":{"L":[{"M":{"title":{"S":"音声"},"name":{"S":"VOICEVOX:ずんだもん"},"url":{"S":"https://voicevox.hiroshiba.jp/"}}},{"M":{"title":{"S":"イラスト"},"name":{"S":"坂本アヒル"},"url":{"S":"https://twitter.com/sakamoto_ahiru"}}}]},"calls":{"L":[{"M":{"message":{"S":"ずんだもんのモーニングコール1"},"voiceFileName":{"S":"call-01.caf"}}},{"M":{"message":{"S":"ずんだもんのモーニングコール2"},"voiceFileName":{"S":"call-02.caf"}}},{"M":{"message":{"S":"ずんだもんのモーニングコール3"},"voiceFileName":{"S":"call-03.caf"}}},{"M":{"message":{"S":"ずんだもんのモーニングコール4"},"voiceFileName":{"S":"call-04.caf"}}},{"M":{"message":{"S":"ずんだもんのモーニングコール5"},"voiceFileName":{"S":"call-05.caf"}}}]},"expressions":{"M":{"normal":{"M":{"imageFileNames":{"L":[{"S":"normal-0.png"},{"S":"smile-0.png"},{"S":"woo-0.png"},{"S":"woo-1.png"}]},"voiceFileNames":{"L":[{"S":"tap-01.caf"},{"S":"tap-02.caf"},{"S":"tap-03.caf"},{"S":"tap-04.caf"},{"S":"tap-05.caf"},{"S":"tap-06.caf"},{"S":"tap-07.caf"},{"S":"tap-08.caf"},{"S":"tap-09.caf"},{"S":"tap-10.caf"}]}}}}}}' \
    --region ap-northeast-1
